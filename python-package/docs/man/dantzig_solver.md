...
Solve the Dantzig selector problem using the parametric simplex method.
The Dantzig selector minimizes the L1 norm of the coefficient vector subject
to a constraint on the L-infinity norm of the correlation between the
...
- `beta0`: `None` (not applicable for Dantzig selector)
